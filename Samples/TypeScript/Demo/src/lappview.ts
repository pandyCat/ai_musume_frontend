...
//
//efine.GearImageName;
//ture = (textureInfo: TextureInfo): void => {
// - textureInfo.width * 0.5;
//t - textureInfo.height * 0.5;
//textureInfo.width;
// textureInfo.height;
//w LAppSprite(x, y, fwidth, fheight, textureInfo.id);
//ubdelegate(this._subdelegate);
//
//
//eateTextureFromPngFile(
// imageName,
//
//
//
